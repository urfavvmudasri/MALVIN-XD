...
module.exports = {
SESSION_ID: process.env.SESSION_ID ||"malvin~Zz8QSTiK#WQd770E_dxwm70CWf3-VYvuFPrkZ-9rov_lhSTr-CSA",
// add your Session Id make sure it starts with malvin~
PREFIX: process.env.PREFIX || "!",
// add your prifix for bot   
BOT_NAME: process.env.BOT_NAME || "MUDASARIII-xᴅ",
...
// add alive msg here 
        ...
        STICKER_NAME: process.env.STICKER_NAME || "Qadeer-xᴅ",
...
// automatic delete links witho remove member 
          ...
          OWNER_NUMBER: process.env.OWNER_NUMBER || "923147479898",
